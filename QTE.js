...
function QTEBlueprint(QTE_blueprint){
    // TODO: Implement the QTE blueprint logic
    // This function should return a position object or style object based on the QTE_blueprint
    switch (QTE_blueprint) {
        case 'QTE_1':
            return Blueprint.QTE_1;
        case 'QTE_2':
            break;
        default:
            console.warn(`Unknown QTE blueprint: ${QTE_blueprint}`);
            return Blueprint.QTE_1; // Fallback to default blueprint
    }
}
